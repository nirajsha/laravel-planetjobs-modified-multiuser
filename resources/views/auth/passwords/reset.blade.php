        ...
        <div class="col-sm-6 col-md-4">
            ...
            <div class="card border-info text-center">
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('admin.password.update')}}" method="post" class="form-signin">
                        @csrf

                        <input type="hidden" name="token" value="{{ $token }}">

                        <input type="email" class="form-control mb-2 {{ $errors->has('email') ? ' is-invalid' : '' }}"  placeholder="Email" required autofocus name="email" id="email">
                        @if ($errors->has('email'))
                        ...
                        <input id="password" type="password" class="form-control mb-2{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" required placeholder="New Password">
                        ...
                        <input id="password-confirm" type="password" class="form-control mb-2" name="password_confirmation" required placeholder="Confirm Password">
